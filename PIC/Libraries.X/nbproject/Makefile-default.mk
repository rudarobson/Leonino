...
SOURCEFILES_QUOTED_IF_SPACED=src/main.c src/leonino/delay.c src/leonino/mem_flash.c src/leonino/usb/ep0.c src/leonino/usb/ep1.c src/leonino/usb/ep2.c src/leonino/usb/usb.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/leonino/delay.p1 ${OBJECTDIR}/src/leonino/mem_flash.p1 ${OBJECTDIR}/src/leonino/usb/ep0.p1 ${OBJECTDIR}/src/leonino/usb/ep1.p1 ${OBJECTDIR}/src/leonino/usb/ep2.p1 ${OBJECTDIR}/src/leonino/usb/usb.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/leonino/delay.p1.d ${OBJECTDIR}/src/leonino/mem_flash.p1.d ${OBJECTDIR}/src/leonino/usb/ep0.p1.d ${OBJECTDIR}/src/leonino/usb/ep1.p1.d ${OBJECTDIR}/src/leonino/usb/ep2.p1.d ${OBJECTDIR}/src/leonino/usb/usb.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/leonino/delay.p1 ${OBJECTDIR}/src/leonino/mem_flash.p1 ${OBJECTDIR}/src/leonino/usb/ep0.p1 ${OBJECTDIR}/src/leonino/usb/ep1.p1 ${OBJECTDIR}/src/leonino/usb/ep2.p1 ${OBJECTDIR}/src/leonino/usb/usb.p1

# Source Files
SOURCEFILES=src/main.c src/leonino/delay.c src/leonino/mem_flash.c src/leonino/usb/ep0.c src/leonino/usb/ep1.c src/leonino/usb/ep2.c src/leonino/usb/usb.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/Libraries.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Libraries.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=icd3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"   --rom=default,-7dc0-7fff --ram=default,-3f4-3ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  -odist/${CND_CONF}/${IMAGE_TYPE}/Libraries.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
