...
const unsigned char dev_desc[] = {
    ...
    LOW_BYTE(DEVICE_ID),
    HIGH_BYTE(DEVICE_ID),
    0x00, //index string of manufacturer
    0x01, //index string of product
...
const unsigned char conf_desc_0[] = {
    ...
    0x00, //string describing interface
